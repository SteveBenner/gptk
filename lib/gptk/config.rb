module GPTK
  ...
  module Config
    def self.load_main_setup
      ...
      load ::File.expand_path '../../../config/main_config.rb', __FILE__
      puts 'Complete.'
    end

    def self.load_openai_setup
      print 'Loading platform-agnostic AI setup code... '
      load ::File.expand_path '../../../config/ai_config.rb', __FILE__
      puts 'Complete.'
    end

    def self.load_book_setup
      print 'Loading book generation parameters... '
      load ::File.expand_path '../../../config/book_config.rb', __FILE__
      puts 'Complete.'
    end
  end
end