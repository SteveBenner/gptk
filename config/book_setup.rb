module GPTK
  class Book
    ...
    CONFIG = {
      ...
      meta_prompt: 'Maintain continuity and do NOT repeat any previously generated material. Generate as much content as possible. Put any conversational material or description from yourself in brackets so as to separate it from the content you generate. AVOID expose, i.e. "telling" instead of "showing" in between fragments. AVOID explaining what is going on at the end of a fragment/chapter, such as "the stage was set" or "the chapter closed". AVOID repeating phrases or elements that have already been used, such as "shivers went down her spine" and "the air was thick with tension". AVOID cliches and trite writing style.'.freeze,
