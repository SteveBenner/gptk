module GPTK
  class Book
    ...
    CONFIG = {
      ...
      meta_prompt: 'Maintain continuity and do NOT repeat any previously generated material. Generate as much content as possible. AVOID commentary to the user; just produce book content. AVOID expose, i.e. "telling" instead of "showing" in between fragments. AVOID explaining what is going on at the end of a fragment/chapter, like "the stage was set" or "the chapter closed". AVOID repeating phrases or elements that have already been used, such as "shivers went down her spine" and "the air was thick with tension". AVOID cliches and trite writing style.'.freeze,
      bad_phrases: [
        'Mind (raced)',
        'Shiver, spine',
